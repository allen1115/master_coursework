$(function(){
    var Self = {
        ...
        initEvent:function(){
            ...
            $("#tab_header div").off("click").on("click",function(e){
                if($(e.currentTarget).attr("href")=='#x3d'){
                    $("#gallery_button_group").css("visibility",'visible')
                }else{
                    $("#gallery_button_group").css("visibility",'hidden')
                }
            })
        },
